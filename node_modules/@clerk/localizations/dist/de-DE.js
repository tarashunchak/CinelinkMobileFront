...
var deDE = {
  ...
  apiKeys: {
    ...
    copySecret: {
      formButtonPrimary__copyAndClose: "Kopieren und schlie\xDFen",
      formHint: "Aus Sicherheitsgr\xFCnden k\xF6nnen Sie es sp\xE4ter nicht mehr einsehen.",
      formTitle: 'Kopieren Sie jetzt Ihren API-Key "{{name}}"'
    },
    createdAndExpirationStatus__expiresOn: "Erstellt {{ createdDate | shortDate('de-DE') }} \u2022 L\xE4uft ab {{ expiresDate | longDate('de-DE') }}",
    createdAndExpirationStatus__never: "Erstellt {{ createdDate | shortDate('de-DE') }} \u2022 L\xE4uft nie ab",
    detailsTitle__emptyRow: "Keine API-Keys gefunden",
    formButtonPrimary__add: "API-Key erstellen",
    formFieldCaption__expiration__expiresOn: "L\xE4uft ab {{ date }}",
  ...
  badge__pastDueAt: "\xDCberf\xE4llig {{ date | shortDate('de-DE') }}",
  badge__pastDuePlan: "\xDCberf\xE4llig",
  ...
  badge__you: "Du",
  billing: {
    addPaymentMethod__label: "Zahlungsmethode hinzuf\xFCgen",
    ...
    cancelFreeTrial: "Kostenlose Testversion k\xFCndigen",
    ...
    cancelFreeTrialTitle: "Kostenlose Testversion f\xFCr {{plan}} Plan k\xFCndigen?",
    ...
    cannotSubscribeUnrecoverable: "Sie k\xF6nnen diesen Plan nicht abonnieren. Ihr vorhandenes Abonnement ist teurer als dieser Plan.",
    checkout: {
      ...
      pastDueNotice: "Ihr vorheriges Abonnement war \xFCberf\xE4llig, ohne Zahlung.",
      perMonth: "pro Monat",
      title: "Bezahlung",
      ...
      totalDueAfterTrial: "Gesamtbetrag f\xE4llig nach Testende in {{days}} Tagen"
    },
    credit: "Guthaben",
    ...
    startFreeTrial__days: "{{days}}-t\xE4gige kostenlose Testversion starten",
    ...
    subscriptionDetails: {
      ...
      nextPaymentAmount: "N\xE4chste Zahlungssumme",
      nextPaymentOn: "N\xE4chste Zahlung am",
      pastDueAt: "\xDCberf\xE4llig am",
      renewsAt: "Verl\xE4ngert sich am",
    ...
    switchToAnnualWithAnnualPrice: "Auf j\xE4hrlich wechseln {{currency}}{{price}} / Jahr",
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      statementsSection: {
        empty: "Keine Abrechnungen verf\xFCgbar",
        itemCaption__paidForPlan: "Bezahlt f\xFCr {{plan}} {{period}} Plan",
        itemCaption__proratedCredit: "Anteilige Gutschrift f\xFCr teilweise Nutzung des vorherigen Abonnements",
        itemCaption__subscribedAndPaidForPlan: "Abonniert und bezahlt f\xFCr {{plan}} {{period}} Plan",
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        ...
        calloutInfoLabel: "\xC4nderungen des Anmeldemodus wirken sich nur auf neue Benutzer aus.",
  ...
  reverification: {
    ...
    backupCodeMfa: {
      subtitle: "Verwenden Sie den Wiederherstellungscode, der Ihnen bei der Registrierung zur Verf\xFCgung gestellt wurde.",
  ...
  signIn: {
    ...
    start: {
      ...
      subtitle: "weiter zu {{applicationName}}",
      subtitleCombined: "Willkommen zur\xFCck! Bitte melden Sie sich an, um fortzufahren",
  ...
  taskChooseOrganization: {
    chooseOrganization: {
      ...
      suggestionsAcceptedLabel: "Genehmigung ausstehend",
      title: "Organisation ausw\xE4hlen"
    },
    createOrganization: {
  ...
  unstable__errors: {
    ...
    form_param_type_invalid: "Der eingegebene Parameter hat einen ung\xFCltigen Typ.",
    form_param_type_invalid__email_address: "Bitte geben Sie eine g\xFCltige E-Mail-Adresse ein.",
    form_param_type_invalid__phone_number: "Bitte geben Sie eine g\xFCltige Telefonnummer ein.",
    ...
    organization_not_found_or_unauthorized: "Sie sind kein Mitglied dieser Organisation mehr. Bitte w\xE4hlen Sie eine andere aus oder erstellen Sie eine neue.",
    organization_not_found_or_unauthorized_with_create_organization_disabled: "Sie sind kein Mitglied dieser Organisation mehr. Bitte w\xE4hlen Sie eine andere aus.",
  ...
  userButton: {
    action__addAccount: "Konto hinzuf\xFCgen",
    action__closeUserMenu: "Benutzermen\xFC schlie\xDFen",
    action__manageAccount: "Konto verwalten",
    action__openUserMenu: "Benutzermen\xFC \xF6ffnen",
    action__signOut: "Abmelden",
  ...
  userProfile: {
    ...
    backupCodePage: {
      ...
      infoText1: "Wiederherstellungscodes werden f\xFCr dieses Konto aktiviert.",
      infoText2: "Halten Sie die Wiederherstellungscodes geheim und bewahren Sie sie sicher auf. Sie k\xF6nnen Wiederherstellungscodes neu generieren, wenn Sie vermuten, dass sie kompromittiert wurden.",
      subtitle__codelist: "Bewahren Sie die Codes sicher auf und halten Sie sie geheim.",
      successMessage: "Wiederherstellungscodes sind jetzt aktiviert. Sie k\xF6nnen eines davon verwenden, um sich bei Ihrem Konto anzumelden, wenn Sie den Zugriff auf Ihr Authentifizierungsger\xE4t verlieren. Jeder Code kann nur einmal verwendet werden.",
      ...
      title: "Wiederherstellungscode-Verifizierung hinzuf\xFCgen",
    ...
    deletePage: {
      ...
      messageLine1: "M\xF6chten Sie Ihr Konto wirklich l\xF6schen? Einige zugeh\xF6rige Daten k\xF6nnen gespeichert bleiben. Um die vollst\xE4ndige L\xF6schung der Daten anzufordern, wenden Sie sich bitte an den Support.",
    ...
    formButtonPrimary__add: "Hinzuf\xFCgen",
    ...
    mfaPhoneCodePage: {
      ...
      removeResource: {
        ...
        messageLine2: "Ihr Konto ist m\xF6glicherweise nicht so sicher. Sind Sie sich sicher, dass Sie fortfahren m\xF6chten?",
      ...
      successMessage1: "Wenn Sie sich anmelden, m\xFCssen Sie einen Best\xE4tigungscode eingeben, der an diese Telefonnummer gesendet wird.",
      successMessage2: "Speichern Sie diese Wiederherstellungscodes und bewahren Sie sie an einem sicheren Ort auf. Falls Sie den Zugriff auf Ihr Authentifizierungsger\xE4t verlieren, k\xF6nnen Sie sich mit diesen Codes anmelden.",
      successTitle: "SMS-Code-Best\xE4tigung aktiviert",
    ...
    mfaTOTPPage: {
      ...
      verifyTitle: "Best\xE4tigungscode"
    },
    ...
    phoneNumberPage: {
      ...
      verifySubtitle: "Geben Sie den Best\xE4tigungscode ein, der an {{identifier}} gesendet wurde",
    ...
    profilePage: {
      ...
      readonly: "Ihre Profilinformationen wurden durch Ihr Unternehmen bereitgestellt und k\xF6nnen nicht bearbeitet werden.",
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__reauthorize: "Die erforderlichen Berechtigungen wurden aktualisiert, wodurch Ihre Funktionalit\xE4t m\xF6glicherweise eingeschr\xE4nkt ist. Bitte autorisieren Sie diese Anwendung erneut, um Probleme zu vermeiden.",
      ...
      mfaSection: {
        backupCodes: {
          ...
          subtitle__regenerate: "Generieren Sie einen neuen Satz sicherer Wiederherstellungscodes. Alte Wiederherstellungscodes werden gel\xF6scht und k\xF6nnen nicht mehr verwendet werden.",
  ...
  waitlist: {
    start: {
      ...
      subtitle: "Geben Sie Ihre E-Mail-Adresse ein und wir benachrichtigen Sie, sobald Ihr Zugang verf\xFCgbar ist.",
