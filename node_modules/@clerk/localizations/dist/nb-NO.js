...
var nbNO = {
  ...
  apiKeys: {
    ...
    copySecret: {
      ...
      formHint: "Av sikkerhetshensyn kan vi ikke tillate deg \xE5 se det igjen senere.",
      formTitle: 'Kopier API-n\xF8kkelen "{{name}}" din n\xE5'
    },
  ...
  formFieldLabel__apiKey: "API-n\xF8kkel",
  formFieldLabel__apiKeyDescription: "Beskrivelse",
  formFieldLabel__apiKeyExpiration: "Utl\xF8per",
  formFieldLabel__apiKeyName: "Navn p\xE5 hemmelig n\xF8kkel",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      confirm: "Slett konto",
      messageLine1: "Er du sikker p\xE5 at du vil slette kontoen din? Noen tilknyttede data kan beholdes. For \xE5 be om full sletting av data, vennligst kontakt kundest\xF8tte.",
      messageLine2: "Denne handlingen er permanent og kan ikke reverseres.",
      title: "Slett konto"
    },
    emailAddressPage: {
