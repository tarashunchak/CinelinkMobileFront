...
var daDK = {
  ...
  apiKeys: {
    ...
    copySecret: {
      formButtonPrimary__copyAndClose: "Kopi\xE9r og luk",
      formHint: "Af sikkerhedsm\xE6ssige \xE5rsager kan vi ikke tillade dig at se det igen senere.",
      formTitle: 'Kopi\xE9r din API-n\xF8gle "{{name}}" nu'
    },
  ...
  formFieldLabel__apiKey: "API-n\xF8gle",
  formFieldLabel__apiKeyDescription: "Beskrivelse",
  formFieldLabel__apiKeyExpiration: "Udl\xF8b",
  formFieldLabel__apiKeyName: "Navn p\xE5 hemmelig n\xF8gle",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      confirm: "Slet konto",
      messageLine1: "Er du sikker p\xE5, at du vil slette din konto? Nogle tilknyttede data kan blive bevaret. For at anmode om fuld datasletning skal du kontakte support.",
      messageLine2: "Denne handling er permanent og kan ikke fortrydes.",
      title: "Slet konto"
    },
    emailAddressPage: {
