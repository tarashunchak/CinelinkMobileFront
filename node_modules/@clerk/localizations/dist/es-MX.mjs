...
var esMX = {
  ...
  apiKeys: {
    ...
    copySecret: {
      ...
      formHint: "Por razones de seguridad, no podr\xE1s verlo de nuevo m\xE1s tarde.",
  ...
  billing: {
    ...
    cancelFreeTrialAccessUntil: "Tu prueba gratuita permanecer\xE1 activa hasta el {{ date | longDate('es-MX') }}. Despu\xE9s de eso, perder\xE1s el acceso a las funciones de prueba y no se te cobrar\xE1.",
    cancelFreeTrialTitle: "\xBFCancelar prueba gratuita del plan {{plan}}?",
  ...
  formFieldLabel__apiKeyDescription: "Descripci\xF3n",
  formFieldLabel__apiKeyExpiration: "Expiraci\xF3n",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "\xBFEst\xE1 seguro de que desea eliminar su cuenta? Es posible que se conserven algunos datos asociados. Para solicitar la eliminaci\xF3n completa de datos, comun\xEDquese con el soporte.",
      messageLine2: "Esta acci\xF3n es permanente e irreversible.",
