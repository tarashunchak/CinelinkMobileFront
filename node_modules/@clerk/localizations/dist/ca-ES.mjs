...
var caES = {
  ...
  apiKeys: {
    ...
    copySecret: {
      ...
      formHint: "Per raons de seguretat, no podr\xE0s veure-ho de nou m\xE9s tard.",
  ...
  billing: {
    ...
    cancelFreeTrial: "Cancel\xB7la la prova gratu\xEFta",
    cancelFreeTrialAccessUntil: "Si cancel\xB7les ara, continuar\xE0s amb la prova gratu\xEFta del pla {{plan}} fins al {{date}}.",
    cancelFreeTrialTitle: "Cancel\xB7la la prova gratu\xEFta pel pla {{plan}}?",
  ...
  formFieldLabel__apiKeyDescription: "Descripci\xF3",
  formFieldLabel__apiKeyExpiration: "Expiraci\xF3",
  ...
  lastAuthenticationStrategy: "\xDAltim \xFAs",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "Esteu segur que voleu suprimir el vostre compte? \xC9s possible que es conservin algunes dades associades. Per sol\xB7licitar la supressi\xF3 completa de les dades, poseu-vos en contacte amb l'assist\xE8ncia.",
      messageLine2: "Aquesta acci\xF3 \xE9s permanent i irreversible.",
