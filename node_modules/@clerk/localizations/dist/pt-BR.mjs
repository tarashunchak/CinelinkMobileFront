...
var ptBR = {
  ...
  apiKeys: {
    ...
    copySecret: {
      ...
      formHint: "Por raz\xF5es de seguran\xE7a, n\xE3o permitiremos que voc\xEA visualize novamente mais tarde.",
    ...
    formFieldCaption__expiration__never: "Esta chave nunca expirar\xE1",
    ...
    formHint: "Forne\xE7a um nome para gerar uma nova chave. Voc\xEA poder\xE1 revog\xE1-la a qualquer momento.",
    formTitle: "Adicionar nova chave de API",
    lastUsed__days: "{{days}}d atr\xE1s",
    lastUsed__hours: "{{hours}}h atr\xE1s",
    lastUsed__minutes: "{{minutes}}min atr\xE1s",
    lastUsed__months: "{{months}}m\xEAs(es) atr\xE1s",
    lastUsed__seconds: "{{seconds}}s atr\xE1s",
    lastUsed__years: "{{years}}a atr\xE1s",
  ...
  badge__you: "Voc\xEA",
  billing: {
    addPaymentMethod__label: "Adicionar m\xE9todo de pagamento",
    alwaysFree: "Gratuito",
    annually: "Anualmente",
    ...
    cancelFreeTrialAccessUntil: "Cancelar acesso ao teste gratuito at\xE9 {{ date | longDate('pt-BR') }}",
    ...
    cannotSubscribeUnrecoverable: "Voc\xEA n\xE3o pode assinar este plano. Sua assinatura existente \xE9 mais cara que este plano.",
    checkout: {
      ...
      totalDueAfterTrial: "Total devido ap\xF3s o teste"
    },
    credit: "Cr\xE9dito",
    ...
    paymentMethods__label: "M\xE9todos de pagamento",
    popular: "Popular",
    pricingTable: {
    ...
    subscriptionDetails: {
      ...
      nextPaymentAmount: "Valor do pr\xF3ximo pagamento",
      nextPaymentOn: "Pr\xF3ximo pagamento em",
    ...
    switchToMonthlyWithPrice: "Mudar para mensal {{currency}}{{price}} / m\xEAs",
  ...
  dividerText: "ou",
  footerActionLink__alternativePhoneCodeProvider: "Enviar c\xF3digo via SMS",
  ...
  formFieldInputPlaceholder__apiKeyDescription: "Explique por que voc\xEA est\xE1 gerando esta chave",
  ...
  formFieldLabel__apiKeyDescription: "Descri\xE7\xE3o",
  formFieldLabel__apiKeyExpiration: "Expira\xE7\xE3o",
  ...
  lastAuthenticationStrategy: "\xDAltimo uso",
  ...
  signIn: {
    ...
    start: {
      ...
      subtitle: "para continuar em {{applicationName}}",
      subtitleCombined: "Bem-vindo de volta! Por favor, fa\xE7a login para continuar",
      title: "Entrar",
  ...
  signUp: {
    ...
    restrictedAccess: {
      ...
      subtitleWaitlist: "Cadastros est\xE3o desabilitados no momento. Para ser um dos primeiros a saber quando lan\xE7armos, entre na lista de espera.",
  ...
  taskChooseOrganization: {
    chooseOrganization: {
      action__createOrganization: "Criar nova organiza\xE7\xE3o",
      action__invitationAccept: "Participar",
      action__suggestionsAccept: "Solicitar participa\xE7\xE3o",
      subtitle: "Junte-se a uma organiza\xE7\xE3o existente ou crie uma nova",
      suggestionsAcceptedLabel: "Aprova\xE7\xE3o pendente",
      title: "Escolha uma organiza\xE7\xE3o"
    },
    createOrganization: {
      formButtonReset: "Cancelar",
      formButtonSubmit: "Criar nova organiza\xE7\xE3o",
      formFieldInputPlaceholder__name: "Minha organiza\xE7\xE3o",
      formFieldInputPlaceholder__slug: "minha-organizacao",
      formFieldLabel__name: "Nome",
      formFieldLabel__slug: "R\xF3tulo do URL",
      subtitle: "Conte-nos um pouco sobre sua organiza\xE7\xE3o",
  ...
  unstable__errors: {
    ...
    form_param_nil: "Campo obrigat\xF3rio.",
    form_param_type_invalid: "Tipo de par\xE2metro inv\xE1lido.",
    form_param_type_invalid__email_address: "Endere\xE7o de e-mail inv\xE1lido.",
    form_param_type_invalid__phone_number: "N\xFAmero de telefone inv\xE1lido.",
    ...
    organization_domain_exists_for_enterprise_connection: "Este dom\xEDnio j\xE1 existe para uma conex\xE3o empresarial.",
    ...
    organization_not_found_or_unauthorized: "Organiza\xE7\xE3o n\xE3o encontrada ou n\xE3o autorizada",
    organization_not_found_or_unauthorized_with_create_organization_disabled: "Organiza\xE7\xE3o n\xE3o encontrada ou n\xE3o autorizada, a cria\xE7\xE3o de organiza\xE7\xF5es est\xE1 desabilitada",
    ...
    web3_missing_identifier: "Uma extens\xE3o de carteira Web3 n\xE3o pode ser encontrada. Por favor, instale uma para continuar.",
    zxcvbn: {
  ...
  userButton: {
    action__addAccount: "Adicionar conta",
    action__closeUserMenu: "Fechar menu do usu\xE1rio",
    action__manageAccount: "Gerenciar conta",
    action__openUserMenu: "Abrir menu do usu\xE1rio",
    action__signOut: "Sair",
    action__signOutAll: "Sair de todas as contas"
  },
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "Tem certeza de que deseja excluir sua conta? Alguns dados associados podem ser mantidos. Para solicitar a exclus\xE3o completa de dados, entre em contato com o suporte.",
      messageLine2: "Esta a\xE7\xE3o \xE9 permanente e irrevers\xEDvel.",
      title: "Excluir conta"
    },
    emailAddressPage: {
