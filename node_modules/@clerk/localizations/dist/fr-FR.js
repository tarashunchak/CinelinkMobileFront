...
var frFR = {
  locale: "fr-FR",
  apiKeys: {
    action__add: "Ajouter une nouvelle cl\xE9",
    action__search: "Rechercher des cl\xE9s",
    copySecret: {
      formButtonPrimary__copyAndClose: "Copier et fermer",
      formHint: "Pour des raisons de s\xE9curit\xE9, nous ne vous permettrons pas de le consulter \xE0 nouveau plus tard.",
      formTitle: 'Copiez votre cl\xE9 API "{{name}}" maintenant'
    },
    createdAndExpirationStatus__expiresOn: "Cr\xE9\xE9e le {{ createdDate | shortDate('fr-FR') }} \u2022 Expire le {{ expiresDate | longDate('fr-FR') }}",
    createdAndExpirationStatus__never: "Cr\xE9\xE9e le {{ createdDate | shortDate('fr-FR') }} \u2022 N\u2019expire jamais",
    detailsTitle__emptyRow: "Aucune cl\xE9 API trouv\xE9e",
    formButtonPrimary__add: "Cr\xE9er une cl\xE9",
    formFieldCaption__expiration__expiresOn: "Expire le {{ date }}",
    formFieldCaption__expiration__never: "Cette cl\xE9 n\u2019expirera jamais",
    ...
    formHint: "Indiquez un nom pour g\xE9n\xE9rer une nouvelle cl\xE9. Vous pourrez la r\xE9voquer \xE0 tout moment.",
    formTitle: "Ajouter une nouvelle cl\xE9 API",
    ...
    menuAction__revoke: "R\xE9voquer la cl\xE9",
    revokeConfirmation: {
      confirmationText: "R\xE9voquer",
      formButtonPrimary__revoke: "R\xE9voquer la cl\xE9",
      formHint: "\xCAtes-vous s\xFBr de vouloir supprimer cette cl\xE9 secr\xE8te ?",
      formTitle: "R\xE9voquer la cl\xE9 secr\xE8te \xAB {{apiKeyName}} \xBB ?"
    }
  },
  backButton: "Retour",
  badge__activePlan: "Actif",
  badge__canceledEndsAt: "Annul\xE9 \u2022 Termine le {{ date | shortDate('fr-FR') }}",
  badge__currentPlan: "Plan actuel",
  badge__default: "D\xE9faut",
  badge__endsAt: "Termine le {{ date | shortDate('fr-FR') }}",
  badge__expired: "Expir\xE9",
  ...
  badge__startsAt: "D\xE9bute le {{ date | shortDate('fr-FR') }}",
  ...
  badge__upcomingPlan: "\xC0 venir",
  badge__userDevice: "Appareil utilisateur",
  badge__you: "Vous",
  billing: {
    addPaymentMethod__label: "Ajouter une m\xE9thode de paiement",
    alwaysFree: "Toujours gratuit",
    annually: "Annuel",
    availableFeatures: "Fonctionnalit\xE9s disponibles",
    billedAnnually: "Factur\xE9 annuellement",
    billedMonthlyOnly: "Seulement factur\xE9 mensuellement",
    cancelFreeTrial: "Annuler l\u2019essai gratuit",
    cancelFreeTrialAccessUntil: "Votre essai restera actif jusqu\u2019au {{ date | longDate('fr-FR') }}. Apr\xE8s cette date, vous perdrez l\u2019acc\xE8s aux fonctionnalit\xE9s d\u2019essai. Aucun frais ne vous sera factur\xE9.",
    cancelFreeTrialTitle: "Annuler l\u2019essai gratuit du plan {{plan}} ?",
    cancelSubscription: "Annuler la souscription",
    cancelSubscriptionAccessUntil: "Souscription annul\xE9e. Vous pouvez continuer \xE0 utiliser les fonctionnalit\xE9s de '{{plan}}' jusqu'au {{ date | longDate('fr-FR') }}, apr\xE8s quoi vous n'aurez plus acc\xE8s.",
    cancelSubscriptionNoCharge: "Pas de charge",
    cancelSubscriptionPastDue: "Votre abonnement prendra fin imm\xE9diatement et vous perdrez l\u2019acc\xE8s \xE0 toutes les fonctionnalit\xE9s du plan. Le montant d\xFB sera demand\xE9 lors de votre prochaine souscription.",
    cancelSubscriptionTitle: "Annuler la souscription",
    cannotSubscribeMonthly: "Ne peut pas souscrire mensuellement. Pour souscrire \xE0 ce plan, il faut payer annuellement.",
    cannotSubscribeUnrecoverable: "Vous ne pouvez pas souscrire \xE0 ce plan. Votre abonnement actuel est plus cher que celui-ci.",
    checkout: {
      description__paymentSuccessful: "Votre paiement a \xE9t\xE9 effectu\xE9 avec succ\xE8s.",
      description__subscriptionSuccessful: "Votre nouvel abonnement est pr\xEAt.",
      downgradeNotice: "Vous conserverez votre abonnement actuel et ses fonctionnalit\xE9s jusqu'\xE0 la fin du cycle de facturation, puis vous passerez \xE0 cet abonnement.",
      emailForm: {
        subtitle: "Avant de pouvoir finaliser votre achat, vous devez ajouter une adresse e-mail o\xF9 les re\xE7us seront envoy\xE9s.",
        title: "Ajouter une adresse e-mail"
      },
      lineItems: {
        title__freeTrialEndsAt: "L\u2019essai se termine le",
        title__paymentMethod: "M\xE9thode de paiement",
        title__statementId: "Identifiant du relev\xE9",
        title__subscriptionBegins: "L'abonnement commence",
        title__totalPaid: "Total pay\xE9"
      },
      pastDueNotice: "Votre abonnement pr\xE9c\xE9dent \xE9tait en retard de paiement.",
      perMonth: "par mois",
      title: "Paiement",
      title__paymentSuccessful: "Le paiement a r\xE9ussi !",
      title__subscriptionSuccessful: "Succ\xE8s !",
      title__trialSuccess: "Essai d\xE9marr\xE9 avec succ\xE8s !",
      totalDueAfterTrial: "Total d\xFB apr\xE8s la fin de l\u2019essai dans {{days}} jours"
    },
    credit: "Cr\xE9dit",
    creditRemainder: "Cr\xE9dit restant",
    defaultFreePlanActive: "Vous \xEAtes actuellement sur le plan gratuit",
    free: "Gratuit",
    getStarted: "Commencer",
    keepFreeTrial: "Conserver l\u2019essai gratuit",
    keepSubscription: "Conserver l'abonnement",
    manage: "G\xE9rer",
    manageSubscription: "G\xE9rer l'abonnement",
    month: "Mois",
    monthly: "Mensuel",
    pastDue: "En retard",
    pay: "Payer {{amount}}",
    paymentMethod: {
      ...
      dev: {
        ...
        cvcZip: "CVC, ZIP",
        developmentMode: "Mode de d\xE9veloppement",
        expirationDate: "Date d'expiration",
        testCardInfo: "Informations de carte de test"
      }
    },
    paymentMethods__label: "M\xE9thodes de paiement",
    popular: "Populaire",
    pricingTable: {
      billingCycle: "Cycle de facturation",
      included: "Inclus"
    },
    reSubscribe: "Se r\xE9abonner",
    seeAllFeatures: "Voir toutes les fonctionnalit\xE9s",
    ...
    subscriptionDetails: {
      ...
      renewsAt: "Renouvel\xE9 le",
      subscribedOn: "Souscrit le",
      title: "Abonnement",
      trialEndsOn: "L\u2019essai se termine le",
      trialStartedOn: "Essai commenc\xE9 le"
    },
    subtotal: "Total",
    switchPlan: "Changer de plan",
    switchToAnnual: "Passer \xE0 l'annuel",
    switchToAnnualWithAnnualPrice: "Passer \xE0 l\u2019annuel {{currency}}{{price}} / an",
    switchToMonthly: "Passer au mensuel",
    switchToMonthlyWithPrice: "Passer au mensuel {{currency}}{{price}} / mois",
    totalDue: "Total d\xFB",
    totalDueToday: "Total d\xFB aujourd'hui",
    viewFeatures: "Voir les fonctionnalit\xE9s",
  ...
  dividerText: "ou",
  footerActionLink__alternativePhoneCodeProvider: "Envoyer le code par SMS \xE0 la place",
  ...
  formFieldInputPlaceholder__apiKeyDescription: "Expliquez pourquoi vous g\xE9n\xE9rez cette cl\xE9",
  formFieldInputPlaceholder__apiKeyExpirationDate: "S\xE9lectionner une date",
  formFieldInputPlaceholder__apiKeyName: "Entrez le nom de votre cl\xE9 secr\xE8te",
  ...
  formFieldLabel__passkeyName: "Nom de la cl\xE9 de s\xE9curit\xE9",
  ...
  lastAuthenticationStrategy: "Derni\xE8re utilisation",
  maintenanceMode: "Nous effectuons des travaux de maintenance, mais ne vous en inqui\xE9tez pas, cela ne devrait pas prendre plus de quelques minutes.",
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      paymentMethodsSection: {
        actionLabel__default: "Rendre par d\xE9faut",
        actionLabel__remove: "Supprimer",
        add: "Ajouter une nouvelle m\xE9thode de paiement",
        addSubtitle: "Ajoutez une nouvelle m\xE9thode de paiement \xE0 votre compte.",
        cancelButton: "Annuler",
        formButtonPrimary__add: "Ajouter une m\xE9thode de paiement",
        ...
        removeMethod: {
          ...
          messageLine2: "Vous ne pourrez plus utiliser cette m\xE9thode de paiement et tous les abonnements r\xE9currents qui en d\xE9pendent ne fonctionneront plus.",
          successMessage: "{{paymentMethod}} a \xE9t\xE9 supprim\xE9 de votre compte.",
          title: "Supprimer une m\xE9thode de paiement"
        },
        title: "M\xE9thodes de paiement"
      },
      start: {
        headerTitle__payments: "Paiements",
        headerTitle__plans: "Plans",
        headerTitle__statements: "Relev\xE9s",
        headerTitle__subscriptions: "Abonnements"
      },
      statementsSection: {
        empty: "Aucun relev\xE9 \xE0 afficher",
        itemCaption__paidForPlan: "Pay\xE9 pour le plan {{plan}} {{period}}",
        itemCaption__proratedCredit: "Cr\xE9dit au prorata pour l\u2019utilisation partielle de l\u2019abonnement pr\xE9c\xE9dent",
        itemCaption__subscribedAndPaidForPlan: "Souscrit et pay\xE9 pour le plan {{plan}} {{period}}",
        notFound: "Relev\xE9 introuvable",
        tableHeader__amount: "Montant",
        tableHeader__date: "Date",
        title: "Relev\xE9s",
        totalPaid: "Total pay\xE9"
      },
      subscriptionsListSection: {
        actionLabel__manageSubscription: "G\xE9rer",
        actionLabel__newSubscription: "S'abonner \xE0 un plan",
        actionLabel__switchPlan: "Changer de plan",
        tableHeader__edit: "Modifier",
        tableHeader__plan: "Plan",
        tableHeader__startDate: "Date de d\xE9but",
        title: "Abonnement"
      },
      subscriptionsSection: {
        actionLabel__default: "G\xE9rer"
      },
      switchPlansSection: {
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling: "Vous n'avez pas les permissions pour g\xE9rer la facturation de cette organisation."
      },
      title: "Plans"
    },
    profilePage: {
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        ...
        manualInvitationOption__description: "Les utilisateurs peuvent uniquement \xEAtre invit\xE9s \xE0 l'organisation manuellement.",
  ...
  reverification: {
    ...
    passkey: {
      blockButton__passkey: "Utiliser votre cl\xE9 de s\xE9curit\xE9",
      subtitle: "L'utilisation de votre cl\xE9 de s\xE9curit\xE9 confirme votre identit\xE9. Votre appareil peut vous demander votre empreinte digitale, votre visage ou votre code de s\xE9curit\xE9.",
      title: "Utiliser votre cl\xE9 de s\xE9curit\xE9"
    },
    password: {
  ...
  signIn: {
    ...
    alternativePhoneCodeProvider: {
      ...
      resendButton: "Vous n\u2019avez pas re\xE7u de code ? Renvoyer",
      subtitle: "pour continuer vers {{applicationName}}",
      title: "V\xE9rifiez votre {{provider}}"
    },
    backupCodeMfa: {
      subtitle: "pour continuer vers {{applicationName}}",
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        actionLink: "Utiliser une autre m\xE9thode",
        label: "Num\xE9ro de t\xE9l\xE9phone {{provider}}",
        subtitle: "Entrez votre num\xE9ro de t\xE9l\xE9phone pour recevoir un code de v\xE9rification sur {{provider}}.",
        title: "Se connecter \xE0 {{applicationName}} avec {{provider}}"
      },
      subtitle: "pour continuer vers {{applicationName}}",
  ...
  signUp: {
    alternativePhoneCodeProvider: {
      resendButton: "Vous n\u2019avez pas re\xE7u de code ? Renvoyer",
      subtitle: "Entrez le code de v\xE9rification envoy\xE9 \xE0 votre {{provider}}",
      title: "V\xE9rifiez votre {{provider}}"
    },
    continue: {
    ...
    emailLink: {
      clientMismatch: {
        subtitle: "Pour continuer, ouvrir le lien de v\xE9rification sur l'appareil et le navigateur depuis lequel vous avez initi\xE9 l'inscription",
        title: "Erreur de correspondance du client"
      },
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        ...
        label: "Num\xE9ro de t\xE9l\xE9phone {{provider}}",
        subtitle: "Entrez votre num\xE9ro de t\xE9l\xE9phone pour recevoir un code de v\xE9rification sur {{provider}}.",
        title: "S\u2019inscrire \xE0 {{applicationName}} avec {{provider}}"
      },
      subtitle: "pour continuer vers {{applicationName}}",
  ...
  taskChooseOrganization: {
    chooseOrganization: {
      action__createOrganization: "Cr\xE9er une nouvelle organisation",
      action__invitationAccept: "Rejoindre",
      action__suggestionsAccept: "Demander \xE0 rejoindre",
      subtitle: "Rejoignez une organisation existante ou cr\xE9ez-en une nouvelle",
      suggestionsAcceptedLabel: "En attente d\u2019approbation",
    ...
    createOrganization: {
      ...
      subtitle: "Entrez les d\xE9tails de votre organisation pour continuer",
      title: "Configurer votre organisation"
    },
    signOut: {
      actionLink: "Se d\xE9connecter",
      actionText: "Connect\xE9 en tant que {{identifier}}"
    }
  },
  unstable__errors: {
    ...
    organization_not_found_or_unauthorized: "Vous n\u2019\xEAtes plus membre de cette organisation. Veuillez en choisir ou en cr\xE9er une autre.",
    organization_not_found_or_unauthorized_with_create_organization_disabled: "Vous n\u2019\xEAtes plus membre de cette organisation. Veuillez en choisir une autre.",
    ...
    web3_missing_identifier: "Aucune extension de portefeuille Web3 trouv\xE9e. Veuillez en installer une pour continuer.",
    zxcvbn: {
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "\xCAtes-vous s\xFBr de vouloir supprimer votre compte ? Certaines donn\xE9es associ\xE9es peuvent \xEAtre conserv\xE9es. Pour demander la suppression compl\xE8te des donn\xE9es, veuillez contacter l'assistance.",
      messageLine2: "Cette action est d\xE9finitive et irr\xE9versible.",
    ...
    emailAddressPage: {
      ...
      formHint: "Vous devrez v\xE9rifier cette adresse e-mail avant qu\u2019elle puisse \xEAtre ajout\xE9e \xE0 votre compte.",
      removeResource: {
        messageLine1: "{{identifier}} sera supprim\xE9 de ce compte.",
    ...
    start: {
      ...
      passkeysSection: {
        ...
        primaryButton: "Ajouter une cl\xE9 de s\xE9curit\xE9",
      ...
      web3WalletsSection: {
        ...
        detailsAction__nonPrimary: "D\xE9finir comme principal",
