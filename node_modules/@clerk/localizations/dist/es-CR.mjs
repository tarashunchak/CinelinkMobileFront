...
var esCR = {
  ...
  badge__you: "Usted",
  billing: {
    addPaymentMethod__label: "A\xF1adir m\xE9todo de pago",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "\xBFEst\xE1 seguro de que desea eliminar su cuenta? Es posible que se conserven algunos datos asociados. Para solicitar la eliminaci\xF3n completa de datos, p\xF3ngase en contacto con el soporte.",
      messageLine2: "Esta acci\xF3n es permanente e irreversible.",
