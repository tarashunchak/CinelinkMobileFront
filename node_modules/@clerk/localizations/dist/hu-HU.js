...
var huHU = {
  ...
  apiKeys: {
    ...
    copySecret: {
      formButtonPrimary__copyAndClose: "M\xE1sol\xE1s \xE9s bez\xE1r\xE1s",
      formHint: "Biztons\xE1gi okokb\xF3l k\xE9s\u0151bb nem fogjuk tudni \xFAjra megengedni, hogy megtekintsd.",
      formTitle: 'M\xE1sold le az "{{name}}" API kulcsot most'
    },
  ...
  billing: {
    ...
    cancelFreeTrial: "Pr\xF3baverzi\xF3 lemond\xE1sa",
    cancelFreeTrialAccessUntil: "A pr\xF3baverzi\xF3d {{date}}-ig marad akt\xEDv.",
    cancelFreeTrialTitle: "Lemondod a(z) {{plan}} csomag pr\xF3baverzi\xF3j\xE1t?",
  ...
  formFieldLabel__apiKeyDescription: "Le\xEDr\xE1s",
  formFieldLabel__apiKeyExpiration: "Lej\xE1rat",
  ...
  lastAuthenticationStrategy: "Legut\xF3bb haszn\xE1lt",
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "Biztosan t\xF6r\xF6lni szeretn\xE9 fi\xF3kj\xE1t? Egyes kapcsol\xF3d\xF3 adatok meg\u0151rz\xE9sre ker\xFClhetnek. A teljes adatt\xF6rl\xE9s k\xE9r\xE9s\xE9hez forduljon az \xFCgyf\xE9lszolg\xE1lathoz.",
      messageLine2: "Ez a m\u0171velet v\xE9gleges \xE9s visszaford\xEDthatatlan.",
