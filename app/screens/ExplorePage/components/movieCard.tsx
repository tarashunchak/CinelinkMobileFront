  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "column", justifyContent: "space-between" }}>
        <View>
          <Image style={styles.card.actions} source={require("@/app/screens/ExplorePage/assets/addToLib.png")} />
        </View>
        <View>
          <Image style={styles.card.actions} source={require("@/app/screens/ExplorePage/assets/remove.png")} />
        </View>
      </View>
    </TouchableOpacity >
  )
