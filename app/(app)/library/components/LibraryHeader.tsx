  ...
  return (
    <HeaderContainer style={stylesR.view}>
      ...
      <View style={styles.right.view}>
        <PressableScale>
          <Image style={styles.right.img} source={require("@/app/(app)/library/assets/icon.png")} />
        </PressableScale>
        <PressableScale onPress={() => navigator.navigate("AddWatchlist")}>
          <Image style={styles.right.img} source={require("@/app/(app)/library/assets/plus.png")} />
        </PressableScale>
      </View>
    </HeaderContainer>
  );
