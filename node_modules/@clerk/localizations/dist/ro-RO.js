...
var roRO = {
  ...
  apiKeys: {
    ...
    copySecret: {
      formButtonPrimary__copyAndClose: "Copiaz\u0103 \u0219i \xEEnchide",
      formHint: "Din motive de securitate, nu v\u0103 vom permite s\u0103 \xEEl vizualiza\u021Bi din nou mai t\xE2rziu.",
    ...
    formHint: "Furnizeaz\u0103 un nume pentru a genera o cheie nou\u0103. O vei putea revoca oric\xE2nd.",
  ...
  badge__canceledEndsAt: "Anulat \u2022 Se \xEEncheie {{ date | shortDate('ro-RO') }}",
  badge__currentPlan: "Plan curent",
  badge__default: "Implicit",
  badge__endsAt: "Se \xEEncheie {{ date | shortDate('ro-RO') }}",
  ...
  badge__renewsAt: "Re\xEEnnoire {{ date | shortDate('ro-RO') }}",
  badge__requiresAction: "Necesit\u0103 ac\u021Biune",
  badge__startsAt: "\xCEncepe {{ date | shortDate('ro-RO') }}",
  badge__thisDevice: "Acest dispozitiv",
  badge__trialEndsAt: "Perioada de prob\u0103 se \xEEncheie {{ date | shortDate('ro-RO') }}",
  ...
  billing: {
    ...
    alwaysFree: "\xCEntotdeauna gratuit",
    annually: "Anual",
    ...
    cancelFreeTrialAccessUntil: "Perioada de prob\u0103 r\u0103m\xE2ne activ\u0103 p\xE2n\u0103 la {{ date | longDate('ro-RO') }}. Dup\u0103 aceea, vei pierde accesul la func\u021Biile de prob\u0103. Nu vei fi taxat.",
    cancelFreeTrialTitle: "Anulezi perioada de prob\u0103 pentru planul {{plan}}?",
    cancelSubscription: "Anuleaz\u0103 abonamentul",
    cancelSubscriptionAccessUntil: "Po\u021Bi folosi \xEEn continuare func\u021Biile \u201E{{plan}}\u201D p\xE2n\u0103 la {{ date | longDate('ro-RO') }}, dup\u0103 care nu vei mai avea acces.",
    ...
    cannotSubscribeUnrecoverable: "Nu te po\u021Bi abona la acest plan. Abonamentul t\u0103u actual este mai scump dec\xE2t acest plan.",
    checkout: {
      ...
      downgradeNotice: "Vei p\u0103stra abonamentul curent \u0219i func\u021Biile sale p\xE2n\u0103 la finalul ciclului de facturare, apoi vei fi schimbat la acest abonament.",
      emailForm: {
        subtitle: "\xCEnainte de a finaliza achizi\u021Bia, adaug\u0103 o adres\u0103 de email unde vor fi trimise chitan\u021Bele.",
        title: "Adaug\u0103 o adres\u0103 de email"
      },
      lineItems: {
        title__freeTrialEndsAt: "Perioada de prob\u0103 se \xEEncheie pe",
        title__paymentMethod: "Metod\u0103 de plat\u0103",
        title__statementId: "ID extras",
        title__subscriptionBegins: "Abonamentul \xEEncepe",
      ...
      title__trialSuccess: "Perioada de prob\u0103 a \xEEnceput!",
      totalDueAfterTrial: "Total de plat\u0103 dup\u0103 ce perioada de prob\u0103 se \xEEncheie \xEEn {{days}} zile"
    },
    credit: "Credit",
    creditRemainder: "Credit pentru restul abonamentului curent.",
    defaultFreePlanActive: "\xCEn prezent e\u0219ti pe planul Gratuit",
    free: "Gratuit",
    getStarted: "\xCEncepe",
    ...
    startFreeTrial: "\xCEncepe perioada de prob\u0103",
    startFreeTrial__days: "\xCEncepe perioada de prob\u0103 de {{days}} zile",
    subscribe: "Aboneaz\u0103-te",
    subscriptionDetails: {
      beginsOn: "\xCEncepe pe",
      currentBillingCycle: "Ciclu de facturare curent",
      endsOn: "Se \xEEncheie pe",
      ...
      renewsAt: "Se re\xEEnnoie\u0219te la",
      subscribedOn: "Abonat pe",
      title: "Abonament",
      trialEndsOn: "Perioada de prob\u0103 se \xEEncheie pe",
      trialStartedOn: "Perioada de prob\u0103 a \xEEnceput pe"
    },
    subtotal: "Subtotal",
  ...
  dates: {
    ...
    nextDay: "M\xE2ine la {{ date | timeString('ro-RO') }}",
  ...
  dividerText: "sau",
  footerActionLink__alternativePhoneCodeProvider: "Trimite codul prin SMS \xEEn schimb",
  ...
  formFieldHintText__slug: "Un \u201Eslug\u201D este un ID u\u0219or de citit care trebuie s\u0103 fie unic. Este folosit adesea \xEEn URL-uri.",
  ...
  formFieldLabel__organizationDomainDeletePending: "\u0218terge invita\u021Biile \u0219i sugestiile \xEEn a\u0219teptare",
  ...
  maintenanceMode: "Efectu\u0103m lucr\u0103ri de mentenan\u021B\u0103, dar nu va dura mai mult de c\xE2teva minute.",
  ...
  organizationList: {
    ...
    suggestionsAcceptedLabel: "\xCEn a\u0219teptare",
    title: "Alege un cont",
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      subscriptionsListSection: {
        ...
        tableHeader__startDate: "Data \xEEnceperii",
        title: "Abonament"
      },
    ...
    invitePage: {
      detailsTitle__inviteFailed: "Invita\u021Biile nu au putut fi trimise. Exist\u0103 deja invita\u021Bii \xEEn a\u0219teptare pentru urm\u0103toarele adrese: {{email_addresses}}.",
    ...
    membersPage: {
      ...
      invitationsTab: {
        autoInvitations: {
          headerSubtitle: "Invit\u0103 utilizatori conect\xE2nd un domeniu de email la organiza\u021Bie. Oricine se \xEEnscrie cu un email ce se potrive\u0219te va putea intra oric\xE2nd.",
      ...
      requestsTab: {
        autoSuggestions: {
          headerSubtitle: "Utilizatorii care se \xEEnscriu cu un email ce se potrive\u0219te pot primi sugestia de a cere acces.",
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        automaticInvitationOption__description: "Utilizatorii sunt invita\u021Bi automat s\u0103 se al\u0103ture \u0219i pot intra oric\xE2nd.",
      ...
      subtitle: "Domeniul {{domain}} a fost verificat. Continu\u0103 select\xE2nd modul de \xEEnscriere.",
  ...
  paginationButton__next: "\xCEnainte",
  paginationButton__previous: "\xCEnapoi",
  ...
  reverification: {
    alternativeMethods: {
      ...
      getHelp: {
        ...
        content: "Dac\u0103 ai probleme la verificare, scrie-ne pe email \u0219i te ajut\u0103m s\u0103-\u021Bi recape\u021Bi accesul c\xE2t mai repede.",
        title: "Ajutor"
      },
    ...
    backupCodeMfa: {
      subtitle: "Introdu codul de rezerv\u0103 primit c\xE2nd ai configurat autentificarea \xEEn doi pa\u0219i",
    ...
    noAvailableMethods: {
      ...
      title: "Nu \xEE\u021Bi putem verifica contul"
    },
    passkey: {
      blockButton__passkey: "Folose\u0219te cheia de acces",
      subtitle: "Folosirea cheii de acces confirm\u0103 identitatea ta. Dispozitivul \xEE\u021Bi poate cere amprenta, fa\u021Ba sau codul de ecran.",
    ...
    totpMfa: {
      ...
      title: "Verificare \xEEn doi pa\u0219i"
    }
  },
  signIn: {
    accountSwitcher: {
    ...
    alternativeMethods: {
      ...
      getHelp: {
        blockButton__emailSupport: "Trimite email la suport",
        content: "Dac\u0103 ai probleme la autentificare, scrie-ne pe email \u0219i te ajut\u0103m s\u0103-\u021Bi recape\u021Bi accesul c\xE2t mai repede.",
        title: "Ajutor"
      },
    ...
    backupCodeMfa: {
      subtitle: "Codul de rezerv\u0103 este cel pe care l-ai primit la configurarea autentific\u0103rii \xEEn doi pa\u0219i.",
      title: "Introdu un cod de rezerv\u0103"
    },
    emailCode: {
      formTitle: "Cod de verificare",
    ...
    emailLink: {
      clientMismatch: {
        subtitle: "Pentru a continua, deschide linkul de verificare pe dispozitivul \u0219i \xEEn browserul de pe care ai \xEEnceput autentificarea",
        title: "Linkul de verificare nu este valid pe acest dispozitiv"
      },
      expired: {
        subtitle: "Revino \xEEn fila ini\u021Bial\u0103 pentru a continua.",
      ...
      loading: {
        subtitle: "Vei fi redirec\u021Bionat \xEEn cur\xE2nd",
        title: "Autentificare..."
      },
      ...
      title: "Verific\u0103-\u021Bi emailul",
      unusedTab: {
        title: "Po\u021Bi \xEEnchide aceast\u0103 fil\u0103"
      },
      verified: {
        subtitle: "Vei fi redirec\u021Bionat \xEEn cur\xE2nd",
      ...
      verifiedSwitchTab: {
        subtitle: "Revino \xEEn fila original\u0103 pentru a continua",
        subtitleNewTab: "Revino \xEEn noua fil\u0103 deschis\u0103 pentru a continua",
        titleNewTab: "Autentificat \xEEn alt\u0103 fil\u0103"
      }
    },
    ...
    forgotPassword: {
      ...
      subtitle_email: "Mai \xEEnt\xE2i introdu codul trimis la adresa de email",
      subtitle_phone: "Mai \xEEnt\xE2i introdu codul trimis pe telefon",
    ...
    passkey: {
      subtitle: "Folosirea cheii de acces confirm\u0103 c\u0103 e\u0219ti tu. Dispozitivul \xEE\u021Bi poate cere amprenta, fa\u021Ba sau blocarea ecranului.",
      title: "Folose\u0219te cheia de acces"
    },
    password: {
      actionLink: "Folose\u0219te alt\u0103 metod\u0103",
    ...
    resetPassword: {
      ...
      requiredMessage: "Din motive de securitate, este necesar s\u0103 \xEE\u021Bi resetezi parola.",
      successMessage: "Parola a fost schimbat\u0103 cu succes. Te autentific\u0103m, te rug\u0103m a\u0219teapt\u0103 un moment.",
      title: "Seteaz\u0103 parol\u0103 nou\u0103"
    },
    resetPasswordMfa: {
      detailsLabel: "Trebuie s\u0103 \xEE\u021Bi verific\u0103m identitatea \xEEnainte de a reseta parola."
    },
    start: {
      actionLink: "\xCEnregistreaz\u0103-te",
      actionLink__join_waitlist: "\xCEnscrie-te pe lista de a\u0219teptare",
      ...
      alternativePhoneCodeProvider: {
        ...
        title: "Autentific\u0103-te \xEEn {{applicationName}} cu {{provider}}"
      },
      subtitle: "Bine ai revenit! Te rug\u0103m s\u0103 te autentifici pentru a continua",
      subtitleCombined: void 0,
      title: "Autentific\u0103-te \xEEn {{applicationName}}",
  ...
  signUp: {
    ...
    continue: {
      ...
      subtitle: "Completeaz\u0103 c\xE2mpurile r\u0103mase pentru a continua.",
      title: "Completeaz\u0103 c\xE2mpurile lips\u0103"
    },
    emailCode: {
      formSubtitle: "Introdu codul de verificare trimis la adresa ta de email",
      formTitle: "Cod de verificare",
    ...
    emailLink: {
      clientMismatch: {
        subtitle: "Pentru a continua, deschide linkul de verificare pe dispozitivul \u0219i \xEEn browserul de pe care ai \xEEnceput \xEEnregistrarea",
        title: "Linkul de verificare nu este valid pe acest dispozitiv"
      },
      formSubtitle: "Folose\u0219te linkul de verificare trimis la adresa ta de email",
      formTitle: "Link de verificare",
      loading: {
        title: "\xCEnregistrare..."
      },
      resendButton: "Nu ai primit un link? Retrimite",
      subtitle: "pentru a continua la {{applicationName}}",
      title: "Verific\u0103-\u021Bi emailul",
      verified: {
        title: "\xCEnregistrare reu\u0219it\u0103"
      },
      verifiedSwitchTab: {
        subtitle: "Revino \xEEn noua fil\u0103 deschis\u0103 pentru a continua",
        subtitleNewTab: "Revino \xEEn fila precedent\u0103 pentru a continua",
    ...
    restrictedAccess: {
      ...
      actionText: "Ai deja cont?",
      blockButton__emailSupport: "Trimite email la suport",
      blockButton__joinWaitlist: "\xCEnscrie-te pe lista de a\u0219teptare",
      subtitle: "\xCEnregistr\u0103rile sunt momentan dezactivate. Dac\u0103 crezi c\u0103 ar trebui s\u0103 ai acces, contacteaz\u0103 suportul.",
      subtitleWaitlist: "\xCEnregistr\u0103rile sunt momentan dezactivate. Pentru a fi primul care afl\u0103 c\xE2nd lans\u0103m, \xEEnscrie-te pe lista de a\u0219teptare.",
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        ...
        label: "Num\u0103r de telefon {{provider}}",
        subtitle: "Introdu num\u0103rul t\u0103u de telefon pentru a primi un cod de verificare pe {{provider}}.",
        title: "\xCEnregistreaz\u0103-te \xEEn {{applicationName}} cu {{provider}}"
      },
      subtitle: "Bun venit! Completeaz\u0103 detaliile pentru a \xEEncepe.",
      subtitleCombined: "Bun venit! Completeaz\u0103 detaliile pentru a \xEEncepe.",
  ...
  unstable__errors: {
    ...
    captcha_unavailable: "\xCEnregistrarea a e\u0219uat din cauza valid\u0103rii anti-bot. Re\xEEmprosp\u0103teaz\u0103 pagina sau contacteaz\u0103 suportul.",
    ...
    form_password_pwned: "Aceast\u0103 parol\u0103 a fost g\u0103sit\u0103 \xEEntr-o bre\u0219\u0103 de securitate \u0219i nu poate fi folosit\u0103. Te rug\u0103m alege alta.",
    form_password_pwned__sign_in: "Aceast\u0103 parol\u0103 a fost g\u0103sit\u0103 \xEEntr-o bre\u0219\u0103 de securitate \u0219i nu poate fi folosit\u0103. Te rug\u0103m reseteaz\u0103 parola.",
    form_password_size_in_bytes_exceeded: void 0,
    form_password_validation_failed: void 0,
    form_username_invalid_character: void 0,
    form_username_invalid_length: "Numele de utilizator trebuie s\u0103 aib\u0103 \xEEntre {{min_length}} \u0219i {{max_length}} caractere.",
    ...
    passkey_already_exists: "Exist\u0103 deja o cheie de acces \xEEnregistrat\u0103 pe acest dispozitiv.",
    passkey_not_supported: "Cheile de acces nu sunt acceptate pe acest dispozitiv.",
    passkey_pa_not_supported: "\xCEnregistrarea necesit\u0103 un autentificator de platform\u0103, dar dispozitivul nu \xEEl suport\u0103.",
    passkey_registration_cancelled: "\xCEnregistrarea cheii de acces a fost anulat\u0103 sau a expirat.",
    ...
    zxcvbn: {
      couldBeStronger: "Parola ta func\u021Bioneaz\u0103, dar ar putea fi mai puternic\u0103. \xCEncearc\u0103 s\u0103 adaugi mai multe caractere.",
      goodPassword: "Parola ta \xEEndepline\u0219te toate cerin\u021Bele necesare.",
      ...
      suggestions: {
        ...
        capitalization: "Folose\u0219te majuscule \u0219i \xEEn alte pozi\u021Bii dec\xE2t prima liter\u0103.",
        ...
        pwned: "Dac\u0103 folose\u0219ti aceast\u0103 parol\u0103 \xEEn alt\u0103 parte, ar trebui s\u0103 o schimbi.",
      ...
      warnings: {
        ...
        pwned: "Parola ta a fost expus\u0103 \xEEntr-o bre\u0219\u0103 de date pe Internet.",
  ...
  userProfile: {
    ...
    backupCodePage: {
      ...
      infoText2: "P\u0103streaz\u0103 codurile de rezerv\u0103 secrete \u0219i stocheaz\u0103-le \xEEn siguran\u021B\u0103. Le po\u021Bi regenera dac\u0103 suspectezi c\u0103 au fost compromise.",
      subtitle__codelist: "Stocheaz\u0103-le \xEEn siguran\u021B\u0103 \u0219i p\u0103streaz\u0103-le secrete.",
      ...
      successSubtitle: "Po\u021Bi folosi unul dintre acestea pentru a te autentifica \xEEn cont dac\u0103 pierzi accesul la dispozitivul de autentificare.",
    ...
    billingPage: {
      paymentHistorySection: {
        empty: "Nu exist\u0103 istoric de pl\u0103\u021Bi",
        notFound: "\xCEncercarea de plat\u0103 nu a fost g\u0103sit\u0103",
        tableHeader__amount: "Sum\u0103",
        tableHeader__date: "Dat\u0103",
        tableHeader__status: "Stare"
      },
      paymentMethodsSection: {
        ...
        actionLabel__remove: "Elimin\u0103",
        add: "Adaug\u0103 metod\u0103 de plat\u0103 nou\u0103",
        addSubtitle: "Adaug\u0103 o nou\u0103 metod\u0103 de plat\u0103 \xEEn contul t\u0103u.",
        cancelButton: "Anuleaz\u0103",
        formButtonPrimary__add: "Adaug\u0103 metoda de plat\u0103",
        formButtonPrimary__pay: "Pl\u0103te\u0219te {{amount}}",
        payWithTestCardButton: "Pl\u0103te\u0219te cu card de test",
    ...
    emailAddressPage: {
      ...
      formHint: "Va trebui s\u0103 verifici aceast\u0103 adres\u0103 de email \xEEnainte de a o ad\u0103uga la cont.",
      removeResource: {
    ...
    mfaPage: {
      ...
      title: "Adaug\u0103 verificare \xEEn doi pa\u0219i"
    },
    mfaPhoneCodePage: {
      ...
      removeResource: {
        ...
        successMessage: "Verificarea \xEEn doi pa\u0219i prin cod SMS a fost eliminat\u0103 pentru {{mfaPhoneCode}}",
        title: "Elimin\u0103 verificarea \xEEn doi pa\u0219i"
      },
      ...
      successMessage2: "Salveaz\u0103 aceste coduri de rezerv\u0103 \xEEntr-un loc sigur. Dac\u0103 pierzi accesul la dispozitivul de autentificare, le po\u021Bi folosi pentru a te autentifica.",
      successTitle: "Verificare prin SMS activat\u0103",
      title: "Adaug\u0103 verificare prin SMS"
    },
    mfaTOTPPage: {
      authenticatorApp: {
        buttonAbleToScan__nonPrimary: "Scaneaz\u0103 codul QR \xEEn schimb",
        buttonUnableToScan__nonPrimary: "Nu po\u021Bi scana codul QR?",
        infoText__ableToScan: "Adaug\u0103 o metod\u0103 nou\u0103 de autentificare \xEEn aplica\u021Bia ta \u0219i scaneaz\u0103 codul QR de mai jos pentru a o lega de cont.",
        infoText__unableToScan: "Adaug\u0103 o metod\u0103 nou\u0103 \xEEn aplica\u021Bia ta de autentificare \u0219i introdu Cheia furnizat\u0103 mai jos.",
      ...
      removeResource: {
        ...
        messageLine2: "Contul t\u0103u ar putea fi mai pu\u021Bin sigur. Sigur vrei s\u0103 continui?",
        successMessage: "Verificarea \xEEn doi pa\u0219i prin aplica\u021Bie de autentificare a fost eliminat\u0103.",
        title: "Elimin\u0103 verificarea \xEEn doi pa\u0219i"
      },
      successMessage: "Verificarea \xEEn doi pa\u0219i este acum activat\u0103. La autentificare va trebui s\u0103 introduci un cod din aceast\u0103 aplica\u021Bie.",
    ...
    profilePage: {
      fileDropAreaHint: "Dimensiune recomandat\u0103 1:1, p\xE2n\u0103 la 10MB.",
      imageFormDestructiveActionSubtitle: "Elimin\u0103",
      imageFormSubtitle: "\xCEncarc\u0103",
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__reauthorize: "Permisiunile necesare au fost actualizate \u0219i po\u021Bi \xEEnt\xE2mpina func\u021Bionalitate limitat\u0103. Te rug\u0103m reautorizeaz\u0103 aplica\u021Bia pentru a evita problemele.",
      ...
      mfaSection: {
        ...
        primaryButton: "Adaug\u0103 verificare \xEEn doi pa\u0219i",
        title: "Verificare \xEEn doi pa\u0219i",
        totp: {
          destructiveActionTitle: "Elimin\u0103",
  ...
  waitlist: {
    start: {
      ...
      formButton: "\xCEnscrie-te pe lista de a\u0219teptare",
      subtitle: "Introdu adresa ta de email \u0219i te vom anun\u021Ba c\xE2nd \xEE\u021Bi vine r\xE2ndul",
      title: "\xCEnscrie-te pe lista de a\u0219teptare"
    },
    success: {
      message: "Vei fi redirec\u021Bionat \xEEn cur\xE2nd...",
      subtitle: "Te vom contacta c\xE2nd \xEE\u021Bi vine r\xE2ndul",
      title: "Mul\u021Bumim pentru \xEEnscriere!"
    }
  }
};
